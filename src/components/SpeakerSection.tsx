    ...
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        ...
        <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <Image height={25} width={25} className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="/img/aman_samuel.jpg" alt="Aman Avatar"/>
                </a>
                <div className="p-5">
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <Image height={25} width={25} className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="/img/anmol_srivastav.jpg" alt="Anmol Avatar"/>
                </a>
                <div className="p-5">
                    <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <Image height={25} width={25} className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="/img/richa_gupta.jpg" alt="Richa Avatar"/>
                </a>
                <div className="p-5">
                    <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
