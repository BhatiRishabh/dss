  ...
  return (
    ...
    <div className="relative md:w-[70%] w-[80%] mx-auto ">
      <div className="absolute md:-top-[7rem] -top-[4rem] flex flex-col items-center">
        ...
        <h2 className="sm:text-5xl text-3xl font-serif mt-10 text-center">About DSS&apos;25</h2>
        ...
        <button className="text-lg font-semibold px-6 py-2 mt-6 outline outline-2 outline-gray-700 rounded-full hover:bg-indigo-500">Register</button>
        </Link>
      </div>
    </div>
  </div></div>
