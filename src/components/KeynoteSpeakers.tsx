  ...
  return (
    <div className="w-full">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        ...
        <h2 className="sm:text-6xl md:text-7xl text-5xl pt-10 font-black text-center">Keynote Speaker</h2>
        ...
        <div className="grid ">
          {speakers.map((speaker, index) => (
            <div key={index} className="w-full bg-gray-900 rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row">
              <div className="w-full md:w-2/5 h-84">
                <Image
                  src={speaker.image}
                  width={500}
                  height={500}
              ...
              <div className="w-full md:w-3/5 text-left p-6 md:p-4 space-y-2">
                <p className="text-4xl sm:pt-24 text-white font-bold">{speaker.name}</p>
                <p className="text-2xl text-gray-400 font-normal">{speaker.role}</p>
                <p className="text-xl leading-relaxed text-gray-500 font-normal">{speaker.bio}</p>
