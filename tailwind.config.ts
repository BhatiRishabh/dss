...
const config: Config = {
  ...
  theme: {
    extend: {
      keyframes: {
        launch: {
          '0%':   { transform: 'rotate(0deg)',  bottom: '3%'  },
      ...
      animation: {
        launch: 'launch 6s ease-in-out infinite',
      },
      colors: {
        primary: {
          50:  "#eff6ff",
      ...
      fontFamily: {
        ...
        // custom faces via your CSS vars:
        helvetica: ['var(--font-helvetica-sans)', 'sans-serif'],
